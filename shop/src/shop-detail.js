define(["./shop-app.js"],function(_shopApp){"use strict";class ShopDetail extends _shopApp.PolymerElement{static get template(){return _shopApp.html`
    ...
    <div id="content" hidden$="[[failure]]">
      ...
      <div class="detail" has-content$="[[_isDefined(item)]]">
        ...
        <div class="pickers">
          <shop-select style="display: none;">
...
ga("send","event",this.item.category,"addedtocart",this.item.name);this.dispatchEvent(new CustomEvent("add-cart-item",{bubbles:!0,composed:!0,detail:{item:this.item,quantity:parseInt(this.$.quantitySelect.value,10),size:this.$.sizeSelect.value}}))}_isDefined(item){return null!=item}_tryReconnect(){this.$.categoryData.refresh()}_offlineChanged(offline){if(!offline){this._tryReconnect()}}}customElements.define(ShopDetail.is,ShopDetail)});